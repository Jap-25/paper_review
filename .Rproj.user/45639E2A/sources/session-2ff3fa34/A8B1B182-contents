...
| **Revista / Volumen / DOI** | arXiv preprint (cs.LG); arXiv:2411.07207v4; 30 Jan 2025. DOI: N/A |
...
### Datos  
El estudio integra **cinco fuentes principales** a nivel **código postal y condado** en la **CONUS** (EE. UU. continental). (i) **Tendencias de búsqueda agregadas** (jul‑2022). (ii) **Mapas (POIs)** (may‑2024). (iii) **Busyness** (H1‑2024). (iv) **Clima & Calidad del aire** (jul‑2022). (v) **SatCLIP** (2021‑2023). Etiquetas *downstream* provienen de **Data Commons / CDC PLACES (2022)** y catálogos (p. ej., *night lights*, elevación).  
...
| **Tareas prioritarias** | Salud (obesidad, hipertensión), pobreza, vulnerabilidad hídrica, contaminación |
