...
| Elemento                           | Detalle                                                                                                             |
|------------------------------------|---------------------------------------------------------------------------------------------------------------------|
| **Referencia corta**               | Han et al. (2018)                                                                                                   |
| **Título completo**                | Large Language Model Powered Intelligent Urban Agents: Concepts, Capabilities, and Applications                       |
| **Revista / Volumen / DOI**        | J. ACM, Vol. 37, No. 4, Article 111 (August 2018), https://doi.org/XXXXXXX.XXXXXXX                                 |
...
## Resultados Clave  
- Urban LLM agents unifican cinco módulos (sensado, memoria, razonamiento, ejecución, aprendizaje).  
